              ...
              <table class="table">
                <thead>
                  <tr>
                    ...
                    <td scope="col">
                      <div class="btn-basic">
                        <span class="btn-basic-wrap">Basic</span>
                      </div>
                    </td>
                    <td scope="col">
                      <div class="btn-pro">
                        <span class="btn-basic-wrap">Pro</span>
                      </div>
                    </td>
                    <td scope="col">
                      <div class="btn-pro-plus">
                        <span class="btn-basic-wrap">Pro +</span>
                      </div>
                    </td>
                  </tr>
                ...
                <tbody class="p-5">
                  ...
                  <tr>
                    ...
                    <td class="plan-title text-center">
                      <strong>$280</strong>
                    </td>
                    <td class="plan-title text-center">
                      <strong>$800</strong>
        ...
        <div class="container">
          <div class="contact-wrap pt-4">
            ...
            <div class="contact-btn-wrap text-center py-4">
              <button
                class="contact-btn btn btn-primary text-white"
                @click="sendEmail"
              >
                Submit
              </button>
    ...
    .table {
      ...
      tbody {
        ...
        tr {
          ...
          &.td-bg-light{
            background-color: #00589f40;
            border-bottom: 4px solid #05223a;
            border-radius: 8px;
          }
